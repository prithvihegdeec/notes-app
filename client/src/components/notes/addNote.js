        ...
        return (
            <div className="row h-100 justify-content-center align-items-center">
                <form onSubmit={
                    ...
                    <div className="form-group">
                        <label >
                            description < input required type="textarea"
                                name="description"
                                className="form-control"
                                value={
                    ...
                    <div className="form-group">
                        <label>
                            Category  <select required value={this.state.select} onChange={this.handleChange} name="select">
